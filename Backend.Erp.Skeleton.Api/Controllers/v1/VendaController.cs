...
namespace Backend.Erp.Skeleton.Api.Controllers.v1
{
    ...
    //[Authorize]
    public class VendaController : BaseApiController<VendaController>
    {
        private readonly IOrcamentoQueryService _queryService;

        public VendaController(IMediator mediator, IOrcamentoQueryService queryService, ILogger<VendaController> logger) : base(mediator, logger)
        {
